    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.JSONField(default=apps.users.models.default_permissions, verbose_name='Permisos')),
            ],
            options={
                'db_table': 'positions',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idEmployee', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.employee', verbose_name='Empleado')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='employee',
            name='idPosition',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='users.position', verbose_name='Cargo'),
        ),
    ]
